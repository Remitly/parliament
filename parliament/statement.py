...
class Statement:
    ...
    def analyze_statement(self):
        ...
        for resource in resources:
            ...
            # The service is in parts[2]
            ...
            elif (not is_valid_region(parts[3])) and parts[4] != "global-cluster":
                has_malformed_resource = True
                self.add_finding(
                    "INVALID_ARN",
                ...
                self.add_finding(
                    "INVALID_ARN",
                    detail=f"Account expected to be of form like 123456789012 but got {parts[4:4+1]}",
                    location=resource,
                )
        ...
        if not has_malformed_resource and self.effect_allow:
            ...
            def _action_requires_star_resource(resource_types):
                ...
                return (resource_types_length == 0) \
                    or (resource_types_length == 1 and resource_types[0]["resource_types"] == "")
